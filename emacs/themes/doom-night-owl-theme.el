;;; doom-night-owl-theme.el --- a high contrast, neon theme inspired by Outrun Electric on VSCode -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-night-owl-theme nil
  "Options for doom-themes."
  :group 'doom-themes)

(defcustom doom-night-owl-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-night-owl-theme
  :type 'boolean)

(defcustom doom-night-owl-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-night-owl-theme
  :type 'boolean)

(defcustom doom-night-owl-comment-bg doom-night-owl-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-night-owl-theme
  :type 'boolean)

(defcustom doom-night-owl-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-night-owl
    "A vibrant, neon colored theme inspired by VS Code Outrun Electric."

  ;; name        default   256       16
  ((bg         '("#0B2942" "#0B2942" nil           ))
   (bg-alt     '("#0B2942" "#0c0a20" nil           ))
   ...
   (fg-alt     '("#D1D5D9" "#D1D5D9" "white"       ))
   (fg         '("#D1D5D9" "#D1D5D9" "brightwhite" ))

   (grey       '("#204462" "#204462" "gray"          ))
   ...
   (selection      dark-blue)
   (builtin        blue)
   (comments       (if doom-night-owl-brighter-comments blue grey))
   (doc-comments   teal)
   (constants      violet)
   (functions      cyan)
   (keywords       magenta)
   ...
   (-modeline-bright doom-night-owl-brighter-modeline)
   (-modeline-pad
    (when doom-night-owl-padded-modeline
      (if (integerp doom-night-owl-padded-modeline) doom-night-owl-padded-modeline 4)))
  ...
  (((font-lock-comment-face &override)
    :background (if doom-night-owl-comment-bg (doom-lighten bg 0.05) 'unspecified))
...
;;; doom-night-owl-theme.el ends here
